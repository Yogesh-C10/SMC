...
export default function TestPage2() {
  ...
  const [timeLeft, setTimeLeft] = useState(questions.length * 60); // Dynamically calculate time left based on number of questions (1 minute per question)
  const [submitted, setSubmitted] = useState(false);
  const [score, setScore] = useState(0);

  // Wrap handleSubmit in useCallback to avoid it being recreated on every render
  ...
  }, [timeLeft, handleSubmit]); // Add handleSubmit as a dependency
  ...
  return (
    <div className="test-page">
      <header className="test-header">
        <h1>Mock Test - General Knowledge</h1>
        <div className="timer">
      ...
      <div className="main-content">
        <div className="question-panel">
          ...
          <button className="prev-btn" onClick={handleMarkForReview}>
